...
%    FLATWIN(N,WIN) returns a symmetric N point Flat-Top window.  WIN
...
%    degree of differentiability, "M" indicates minimum sidelobe, and "HFT"
%    indicates the window with lowest sidelobe level.
%
%    See also FLATTOPWIN.
%
%    Ref:
